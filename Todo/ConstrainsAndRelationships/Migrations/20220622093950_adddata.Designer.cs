...
namespace ConstrainsAndRelationships.Migrations
{
    ...
    [Migration("20220622093950_adddata")]
            ...
            modelBuilder.Entity("ConstrainsAndRelationships.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InstructorId = 1,
                            StartData = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9905)
                        },
                        new
                        {
                            DepartmentId = 2,
                            ...
                            DepartmentName = "数学学院",
                            InstructorId = 1,
                            StartData = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9907)
                        },
                        new
                        {
                            DepartmentId = 3,
                            ...
                            DepartmentName = "外语学院",
                            InstructorId = 1,
                            StartData = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9908)
                        });
                });
            ...
            modelBuilder.Entity("ConstrainsAndRelationships.Models.Instructor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InstructorId = 1,
                            HireDate = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9876),
                            InstructorName = "Sky1"
                        },
                        new
                        {
                            InstructorId = 2,
                            HireDate = new DateTime(2022, 6, 23, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9878),
                            InstructorName = "Sky2"
                        },
                        new
                        {
                            InstructorId = 3,
                            HireDate = new DateTime(2022, 6, 24, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9885),
                            InstructorName = "Sky3"
                        },
                        new
                        {
                            InstructorId = 4,
                            HireDate = new DateTime(2022, 6, 25, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9885),
                            InstructorName = "Sky4"
                        });
                });
            ...
            modelBuilder.Entity("ConstrainsAndRelationships.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StudentId = 1,
                            EnrollmentDate = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9843),
                            StudentName = "s1"
                        },
                        new
                        {
                            StudentId = 2,
                            EnrollmentDate = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9847),
                            StudentName = "s2"
                        },
                        new
                        {
                            StudentId = 3,
                            EnrollmentDate = new DateTime(2022, 6, 22, 9, 39, 50, 331, DateTimeKind.Utc).AddTicks(9848),
                            StudentName = "s3"
                        });
                });
